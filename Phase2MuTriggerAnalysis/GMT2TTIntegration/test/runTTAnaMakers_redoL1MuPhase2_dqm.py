...
process.load("DQM.L1TMonitor.L1TGMT_cfi")
process.dqm_path = cms.Path(process.l1tGmt)
process.l1tGmt.gmtSource = "simGmtDigis"
process.load("Configuration.StandardSequences.EDMtoMEAtJobEnd_cff")
process.dqmsave_step = cms.Path(process.DQMSaver)

process.schedule = cms.Schedule(process.pMuons,process.dqm_path,process.outpath,process.dqmsave_step)
