...
namespace lst {
  ...
  inline LSTInputHostCollection prepareInput(std::vector<float> const& see_px,
    ...
    std::memcpy(pixelSeeds.firstHit().data(), firstHit_vec.data(), nPixelSeeds * sizeof(unsigned int));
    std::memcpy(pixelSeeds.nHits().data(), nHits_vec.data(), nPixelSeeds * sizeof(uint8_t));
    std::memcpy(pixelSeeds.hitDetBits().data(), hitDetBits_vec.data(), nPixelSeeds * sizeof(uint8_t));
