...
public:
  ...
  ~DTRechitClusterProducer() override;
...
void DTRechitClusterProducer::produce(edm::Event& ev, const edm::EventSetup& iSetup) {
...
void DTRechitClusterProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
